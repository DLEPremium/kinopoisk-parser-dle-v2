...
echoheader('<b>DLE Парсер КиноПоиск V2</b>', 'Настройки модуля DLE Парсер КиноПоиск V2');
...
showRow('Введите ваш API токен от kinopoisk.dev', 'Зарегистрируйтесь <a href="https://kinopoisk.dev/" target="_blank" rel="noreferrer">на сайте</a>, после получения API токена от сервиса введите его тут', showInput(['settings[kinopoiskdev]', 'text', $kp_config['settings']['kinopoiskdev']]));
...
<div class="panel" style="margin-top: 20px;">
	<div class="panel-content">
		<div class="panel-body">
			© 2023 <a href="https://github.com/DLEPremium/kinopoisk-parser-dle-v2" target="_blank">MrDeath</a>
		</div>
	</div>
</div>
<script>
