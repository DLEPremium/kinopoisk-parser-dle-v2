...
$cat_type = ['movie' => 'Фильм', 'tv-series' => 'Сериал', 'cartoon' => 'Мультфильм', 'anime' => 'Аниме', 'animated-series' => 'Аниме сериал', 'tv-show' => 'ТВ-шоу'];
$cat_type_en = ['movie' => 'movie', 'tv-series' => 'tvserial', 'cartoon' => 'cartoon', 'anime' => 'anime', 'animated-series' => 'animeserial', 'tv-show' => 'tvshow'];

$statuses = ['filming' => 'снимается', 'pre-production' => 'подготовка к съемкам', 'completed' => 'завершён', 'announced' => 'анонсировано', 'post-production' => 'пост-продакшн'];
...
elseif ( $action == "kinopoisk_get" ) {
	...
	if ( $need_screens === true ) {
	    ...
	    $screens_list = api_request('https://api.kinopoisk.dev/v1/image?page=1&limit=10&movieId='.$kp_id.'&type=still', $kp_config['settings']['kinopoiskdev'] );
	    if ( $screens_list['docs'] ) {
	        ...
	        if ( $screens_list['docs'][0]['url'] AND 1 <= $kp_config['images']['screens_count'] ) {
                $screen_1_file = $screen_named.'_kadr_1';
                $screen_1 = setPoster($screens_list['docs'][0]['url'], $screen_1_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
	        ...
	        if ( $screens_list['docs'][1]['url'] AND 2 <= $kp_config['images']['screens_count'] ) {
                $screen_2_file = $screen_named.'_kadr_2';
                $screen_2 = setPoster($screens_list['docs'][1]['url'], $screen_2_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
	        ...
	        if ( $screens_list['docs'][2]['url'] AND 3 <= $kp_config['images']['screens_count'] ) {
                $screen_3_file = $screen_named.'_kadr_3';
                $screen_3 = setPoster($screens_list['docs'][2]['url'], $screen_3_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
	        ...
	        if ( $screens_list['docs'][3]['url'] AND 4 <= $kp_config['images']['screens_count'] ) {
                $screen_4_file = $screen_named.'_kadr_4';
                $screen_4 = setPoster($screens_list['docs'][3]['url'], $screen_4_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
	        ...
	        if ( $screens_list['docs'][4]['url'] AND 5 <= $kp_config['images']['screens_count'] ) {
                $screen_5_file = $screen_named.'_kadr_5';
                $screen_5 = setPoster($screens_list['docs'][4]['url'], $screen_5_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
	        ...
	        if ( $screens_list['docs'][5]['url'] AND 6 <= $kp_config['images']['screens_count'] ) {
                $screen_6_file = $screen_named.'_kadr_6';
                $screen_6 = setPoster($screens_list['docs'][5]['url'], $screen_6_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
	        ...
	        if ( $screens_list['docs'][6]['url'] AND 7 <= $kp_config['images']['screens_count'] ) {
                $screen_7_file = $screen_named.'_kadr_7';
                $screen_7 = setPoster($screens_list['docs'][6]['url'], $screen_7_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
	        ...
	        if ( $screens_list['docs'][7]['url'] AND 8 <= $kp_config['images']['screens_count'] ) {
                $screen_8_file = $screen_named.'_kadr_8';
                $screen_8 = setPoster($screens_list['docs'][7]['url'], $screen_8_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
	        ...
	        if ( $screens_list['docs'][8]['url'] AND 9 <= $kp_config['images']['screens_count'] ) {
                $screen_9_file = $screen_named.'_kadr_9';
                $screen_9 = setPoster($screens_list['docs'][8]['url'], $screen_9_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
	        ...
	        if ( $screens_list['docs'][9]['url'] AND 10 <= $kp_config['images']['screens_count'] ) {
                $screen_10_file = $screen_named.'_kadr_10';
                $screen_10 = setPoster($screens_list['docs'][9]['url'], $screen_10_file, 'kadr', $kp_config['images']['xf_screens'], $id_news);
