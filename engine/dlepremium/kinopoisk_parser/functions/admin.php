...
'Сюжет',
'Краткий сюжет',
'Статус производства на английском (filming, pre-production, completed, announced, post-production)',
'Статус производства на русском (снимается, подготовка к съемкам, завершён, анонсировано, пост-продакшн)',
...
'Монтажеры',
'Актёры дубляжа',
'Сиквелы и приквелы (список из id КП)',
'Похожие (список из id КП)',
'Место в топ 10 для фильмов',
'Место в топ 10 для сериалов',
'Место в топ 250 для фильмов',
'Место в топ 250 для сериалов',
'Список коллекций',
